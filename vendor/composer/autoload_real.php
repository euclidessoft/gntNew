...
class ComposerAutoloaderInit54c05e64f01f49eb136e9af7b3075bdd
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit54c05e64f01f49eb136e9af7b3075bdd::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire54c05e64f01f49eb136e9af7b3075bdd($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire54c05e64f01f49eb136e9af7b3075bdd($fileIdentifier, $file)
{
